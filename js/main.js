...
function segundo(){
	$('#contenido').show().animateCss('slideInUp');
...
function tercero(){
  ...
  $('#contenido').html('<center><img src = "img/colilla.jpg" class="banner"> <div class="container"><div class="row"><div class="col-xs-12 col-sm-6 col-lg-3"><img src="img/noticias/8.jpg" class ="primera img-responsive" width="200" /> <br><br> <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal4"> Ver Noticias</button> <div id="myModal4" class="modal fade" role="dialog"> <div class="modal-dialog"> <div class="modal-content"> <div class="modal-header"> <button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title"> 5 de agosto de 2016</h4> </div> <div class="modal-body"><p> Diseño y elaboración de accesorios de Bisutería</p><br> <img src ="img/noticias/8.jpg" class ="img-responsive"/> </div> <div class="modal-footer"> <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> </div></div></div></div></div><div class="col-xs-12 col-sm-6 col-lg-3"><img src="img/noticias/7.jpg" class ="primera img-responsive" width="200" /> <br><br> <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal4"> Ver Noticias</button> <div id="myModal4" class="modal fade" role="dialog"> <div class="modal-dialog"> <div class="modal-content"> <div class="modal-header"> <bu tton type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title">Así se vivió SENA MODA 2016</h4> </div> <div class="modal-body"><p> La semana pasada se vivió una jornada de moda en nuestro centro de formación. Como preámbulo a la feria Colombiamoda, se ofrecieron conferencias, talleres y laboratorios de experiencias dirigidos al público en general, esto con el fin de dar a conocer las nuevas tecnologías que se implementan en el sector de diseño y confección; así como los trabajos realizados por aprendices de la mano de sus instructores.</p><br> <img src ="img/noticias/4.jpg" class ="img-responsive"/> <img src = "img/colilla.jpg" class="banner"> <img src ="img/noticias/5.jpg" class ="img-responsive"/> </div> <div class="modal-footer"> <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> </div></div></div></div></div><div class="col-xs-12 col-sm-6 col-lg-3"><img src="img/noticias/1.jpg" class="primera img-responsive" width="200"/><br><br><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Ver Noticias</button><div id="myModal" class="modal fade" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Noticias</h4></div><div class="modal-body"><p>Lugar:Auditorio del 6to. Piso del Mobiliario Hora:8:00 a.m. a 10:00 p.m Día:miércoles 18 de mayo de 2016.</p><br><img src="img/noticias/1.jpg" class="img-responsive"/></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Close</button> </div></div></div></div></div><div class="col-xs-12 col-sm-6 col-lg-3"> <img src="img/noticias/3.jpg" class="primera img-responsive" width="200"/><br><br><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal3">Ver Noticias</button><div id="myModal3" class="modal fade" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Noticias</h4></div><div class="modal-body"><p>Cuerpo,Cultura y contexto</p><br><img src="img/noticias/3.jpg" class="img-responsive"/></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Close</button> </div></div></div></div></div><div class="col-xs-12 col-sm-6 col-lg-3"></i><img src="img/noticias/5.png" class="primera img-responsive" width="200"/><br><br><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal4">Ver Noticias</button><div id="myModal4" class="modal fade" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Noticias</h4></div><div class="modal-body"><p>5 de agosto de 2016.</p><br><img src="img/noticias/7.png" class="img-responsive"/></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div> </div> </div> </div> </div> </div></div></div></div>');	$('#logo').hide();
}
function cuarto(){
